...
def mainroot():
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Souparna Roy",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : rvce@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Ms. Surya Harsha",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : rvce@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mr. Rajat Dhuva",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : rvce@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mrs. someone",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Extention : 041",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail : rvce@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)
		emp1inf.pack_propagate(False)
	...
	def reserve():
		...
		noc.insert(0, ' Semester *')
		noa.insert(0, 'Type of acommodation *')
		...
		def on_entry_click8(event):
			if noa.get() == 'Type of Accomodation *' :
				noa.delete(0,END)
				noa.insert(0,'')
		...
		def on_exit8(event):
			if noa.get()=='':
				noa.insert(0,'Type of Accomodationpython main. *')
		def on_exit9(event):
			if nod.get()=='':
				nod.insert(0,'Number of Days of Stay *')
